	...
	<section class="bg-[url('/images/banner.png')] bg-cover bg-no-repeat" style="background-position: 80% 50%;">
		<div class="width-lg grid md:grid-cols-2 sm:grid-cols-1 min-h-screen pb-8 pt-2 flex items-center bg-gradient-to-l from-zinc-900 md:from-transparent to-100% to-transparent">
			<div>
				...
				<p>a final year at <a href="https://jaipur.manipal.edu" target="_blank" aria-label="Manipal University">Manipal University</a> majoring in CS with an hons. in AI & ML. I get psyched out by robots, and I am building <a href="https://projectendgame.tech" target="_blank" aria-label="Project Endgame">Endgame</a> full-time.</p>
